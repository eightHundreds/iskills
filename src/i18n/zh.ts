...
export const zh = {
  ...
  // ── labels (field names) ────────────────────────────────────────────────
  'label.collectionStatus': '收藏状态',
  'label.description': '描述',
  'label.location': '位置',
  'label.note': '备注',
  'label.path': '路径',
  'label.relatedLocations': '关联位置',
  'label.source': '来源',
  'label.tags': '标签',
...
`,
  ...
  'cmd.editNote': '编辑备注（Enter 保存，Esc 取消）',
  ...
  'browser.helpNavGroup': '跳转分组（有分组时）',
  ...
  'import.selectGroups': '选择分组',
  'import.newGroupsComma': '新增分组（逗号分隔）',
  'import.groupInputFooter': 'Enter 完成分组 · Tab 返回已有分组 · Esc 取消',
  ...
  'ui.tagEditorHeader': '{title} · 已选 {count}',
  ...
  'import.selectedGroups': '已选分组：{tags}',
  'import.noExistingGroups': '暂无已有分组',
  'import.willImport': '将导入 {count} 个技能；分组：',
  'import.moreItems': '… 还有 {count} 个',
  'import.confirmFooter': 'Enter 确认导入 · ← 返回分组 · n 取消 · Esc 取消',
